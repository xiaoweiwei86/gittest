    ...
    <section id="content" class="table-layout animated fadeIn">
        <div class="tray tray-center">
            <div class="content-header">
                <h2><span style="color: #1c7393">${USER.realName}</span>您好，您正在修改资产分类！ </h2>
            ...
            <div class="admin-form theme-primary mw600 center-block" style="padding-bottom: 175px;">
                <div class="panel heading-border">
                    <form id="admin-form" name="addForm" action="${pageContext.request.contextPath }/category/edit"
                          method="post">
                        <div class="panel-body bg-light">
                            ...
                            <div class="section row ">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="name" id="name" class="gui-input" required="required"
                                           placeholder="请输入分类名..." value="${category.name}">
                                </div>
                            </div>
                            <div class="section row ">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control" name="type" id="type">
                                        <option value="${category.type}" selected="selected">${category.type}</option>
                                       <c:if test="${category.type!='固定资产'}">
                                           <option value="固定资产">固定资产</option>
                                       </c:if>
                                        <c:if test="${category.type!='生产物料'}">
