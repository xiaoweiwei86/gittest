                ...
                <form action="${pageContext.request.contextPath}/asset/search" method="post">
                    <div class="section">
                        <div class="section row center-block">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="keywords" name="keywords"
                                               placeholder="输入关键字搜索..." style="width:120%" value="${keywords}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <select type="text" class="form-control" id="team" name="team" style="width:80%">
                                        <option value="" selected="selected">请选择部门搜索...</option>
                                        <c:forEach items="${teams}" var="team" >
                                            <option value="${team.teamName}" <c:if test="${team.teamName==teamValue}"> selected="selected" </c:if> >${team.teamName}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                                ...
                                <tr class="message-unread">
                                    ...
                                    <td class=""><a class="btn btn-primary" onclick="show(${asset.id},'${asset.name}')">查看</a>&nbsp;
                                        <a class="btn btn-primary"
                                           href="${pageContext.request.contextPath}/asset/to_edit?id=${asset.id}">修改</a>&nbsp;
                                            <%--<a class="btn btn-primary" onclick="confirm(${asset.id})">删除</a>&nbsp;--%>
                                        <a class="btn btn-primary"
                                           href="${pageContext.request.contextPath}/handover_order/to_add_by_asset?assetId=${asset.id}">交接</a>
                    ...
                    <c:if test="${isSearch!=1}">
                        <nav aria-label="Page navigation">
                            <div class="panel-footer text-right remove-padding-horizontal pager-footer">
                                ...
                                <ul class="pagination">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/asset/list?pageNum=1"><span>首页</span></a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/asset/list?pageNum=${page.pageNum-1}"><span>上一页</span></a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/asset/list?pageNum=${page.pageNum+1}"><span>下一页</span></a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/asset/list?pageNum=${page.pages}"><span>尾页</span></a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
                    ...
                    <c:if test="${isSearch==1}">
                        <nav aria-label="Page navigation">
                            <div class="panel-footer text-right remove-padding-horizontal pager-footer">
                                ...
                                <ul class="pagination">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/asset/search?pageNum=1&keywords=${keywords}&team=${teamValue}&categoryId=${categoryId}&flag=0"><span>首页</span></a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/asset/search?pageNum=${page.pageNum-1}&keywords=${keywords}&team=${teamValue}&categoryId=${categoryId}&flag=0"><span>上一页</span></a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/asset/search?pageNum=${page.pageNum+1}&keywords=${keywords}&team=${teamValue}&categoryId=${categoryId}&flag=0"><span>下一页</span></a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/asset/search?pageNum=${page.pages}&keywords=${keywords}&team=${teamValue}&categoryId=${categoryId}&flag=0"><span>尾页</span></a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
