    ...
    <section id="content" class="table-layout animated fadeIn">
        <div class="tray tray-center">
            <div class="content-header">
                <h2><span style="color: #1c7393">${user.realName}</span>您好，您正在修改经验数据库。 </h2>
                <p class="lead" style="margin-top: 20px"></p>
            </div>
            <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
                <div class="panel heading-border">
                    <form action="<%=basePath%>/ed/edit" method="post" onsubmit="return isValid(this)">
                        <div class="panel-body bg-light">
                            ...
                            <div class="section row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input list="primeCategory" name="primeCategory" class="form-control"
                                           value="${experienceDatabase.primeCategory}"/>
                            ...
                            <input type="hidden" name="id" value="${experienceDatabase.id}"/>
                            <input type="hidden" name="userId" value="${experienceDatabase.userId}"/>
                            <input type="hidden" name="entryPerson" value="${experienceDatabase.entryPerson}"/>
                            <input type="hidden" name="audit" value="${experienceDatabase.audit}"/>
                            <input type="hidden" name="recommend" value="${experienceDatabase.recommend}"/>
