                            ...
                            <tr class="message-unread">
                                ...
                                <td class="">
                                    ...
                                    <c:if test="${handoverOrder.statusNo==1||handoverOrder.statusNo==0}">
                                        ...
                                        <a class="btn btn-primary" onclick="confirm(${handoverOrder.id})">删除</a>&nbsp;
                                    </c:if>
                                    <c:if test="${handoverOrder.statusNo==0}">
                                        <a class="btn btn-primary" onclick="submitCheck(${handoverOrder.id})">提交</a>&nbsp;
                                    </c:if>
                                </td>
                            </tr>
                            </c:forEach>
                    ...
                    <c:if test="${isSearch!=1}">
                        <nav aria-label="Page navigation">
                            <div class="panel-footer text-right remove-padding-horizontal pager-footer">
                                ...
                                <ul class="pagination">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/handover_order/myself_list?pageNum=1"><span>首页</span></a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/handover_order/myself_list?pageNum=${page.pageNum-1}"><span>上一页</span></a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/handover_order/myself_list?pageNum=${page.pageNum+1}"><span>下一页</span></a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/handover_order/myself_list?pageNum=${page.pages}"><span>尾页</span></a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
                    ...
                    <c:if test="${isSearch==1}">
                        <nav aria-label="Page navigation">
                            <div class="panel-footer text-right remove-padding-horizontal pager-footer">
                                ...
                                <ul class="pagination">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/handover_order/search?pageNum=1&assetNumbers=${assetNumbers}&acceptTeam=${acceptTeam}&flag=${flag}"><span>首页</span></a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/handover_order/search?pageNum=${page.pageNum-1}&assetNumbers=${assetNumbers}&acceptTeam=${acceptTeam}&flag=${flag}"><span>上一页</span></a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/handover_order/search?pageNum=${page.pageNum+1}&assetNumbers=${assetNumbers}&acceptTeam=${acceptTeam}&flag=${flag}"><span>下一页</span></a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/handover_order/search?pageNum=${page.pages}&assetNumbers=${assetNumbers}&acceptTeam=${acceptTeam}&flag=${flag}"><span>尾页</span></a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
